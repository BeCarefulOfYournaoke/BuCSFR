...
class ModelBase(nn.Module):
    ...
    base2ckpt = {
        "vit_small": "/media/disk12T/2022-sgh/sgh/03_third/BUEM/mocov3/vit-s-300ep.pth.tar", 
        "vit_base": "/media/disk12T/2022-sgh/sgh/03_third/BUEM/mocov3/vit-b-300ep.pth.tar"
    }
    def __init__(self, base_encoder, args, dim=128):
        super(ModelBase, self).__init__()

        mlp_dim = 4096
        self.net = base_encoder(num_classes=mlp_dim)

        checkpoint = torch.load(ModelBase.base2ckpt[args.arch], map_location="cpu")
        ...
        print("=> loaded pre-trained model '{}' with msg {}".format(ModelBase.base2ckpt[args.arch], msg))

        print(self.net)
        self.dim_mlp = self.net.head.weight.shape[1]
